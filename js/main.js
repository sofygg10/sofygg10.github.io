...
(() => {
  ...
  const I18N = {
    es: {
      ...
      'projects.p3.desc': 'Aplicación <strong>Node.js / Express</strong> que identifica los rasgos de una mascota a partir de una foto y devuelve un avatar estilizado tipo <em>Pixar / Dreamworks</em> usando <strong>Google Vision</strong> y <strong>Fireworks AI (FLUX.1)</strong>.',
      'projects.p3.fn.1': 'Reconocimiento de imagen con Vision AI (especie, raza, color, edad)',
      'projects.p3.fn.2': 'Búsqueda inteligente en catálogo local de avatares',
      'projects.p3.fn.3': 'Generación con FLUX.1 cuando no hay match',
      'projects.p3.fn.4': 'Caché automático: el sistema "aprende" y se vuelve más rápido',
      'projects.p3.fn.5': 'Gestión de subidas con Multer',
      'projects.p3.fn.6': 'Preparado para desplegar en Oracle Cloud (OCI)',
      'projects.p3.objective': 'Entregar avatares estilizados que reflejen los rasgos reales de cada mascota, en segundos y sin intervención manual.',
      'projects.p3.challenges': 'Conectar Vision AI con un catálogo dinámico, decidir cuándo reutilizar y cuándo generar con FLUX.1, y mantener la consistencia visual del estilo.',
      'projects.p3.results': 'Pipeline end-to-end: foto → atributos → avatar. Cada generación enriquece el catálogo, reduciendo costos y tiempos de respuesta.',
      ...
      'journey.3.phase': '2023 – 2024 · Creative Studios SAS',
      'journey.3.title': 'Analista SEO &amp; Desarrolladora Frontend',
      'journey.3.body': 'Auditorías técnicas con Screaming Frog, Ahrefs y Semrush. Optimización de velocidad y estructura. Frontend con HTML, CSS y JavaScript. Administración de WordPress y Wix.',
    ...
    en: {
      ...
      'projects.p3.desc': '<strong>Node.js / Express</strong> app that identifies pet traits from a photo and returns a stylized <em>Pixar / Dreamworks</em>-like avatar using <strong>Google Vision</strong> and <strong>Fireworks AI (FLUX.1)</strong>.',
      'projects.p3.fn.1': 'Image recognition with Vision AI (species, breed, color, age)',
      'projects.p3.fn.2': 'Smart search across a local avatar catalog',
      'projects.p3.fn.3': 'FLUX.1 generation when no match is found',
      'projects.p3.fn.4': 'Automatic cache: the system "learns" and gets faster',
      'projects.p3.fn.5': 'Upload handling with Multer',
      'projects.p3.fn.6': 'Ready to deploy on Oracle Cloud (OCI)',
      'projects.p3.objective': 'Deliver stylized avatars that reflect each pet\'s real traits, in seconds and with no manual intervention.',
      'projects.p3.challenges': 'Connect Vision AI to a dynamic catalog, decide when to reuse vs. when to generate with FLUX.1, and keep the visual style consistent.',
      'projects.p3.results': 'End-to-end pipeline: photo → attributes → avatar. Every generation enriches the catalog, lowering cost and response time.',
      ...
      'journey.3.body': 'Technical audits with Screaming Frog, Ahrefs and Semrush. Speed and structure optimization. Frontend with HTML, CSS and JavaScript. WordPress and Wix administration.',
